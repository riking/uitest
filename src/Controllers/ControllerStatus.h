...
struct ControllerStateLeft : ControllerState {
    ControllerStateLeft(JoyConStatus jc_left) : ControllerState(ControllerTypeLeft) {
        m_jc_left = jc_left;
    };
    void accept(ControllerStateVisitor& visitor){ visitor.visit(*this); }
...
struct ControllerStateRight : ControllerState {
    ControllerStateRight(JoyConStatus jc_right) : ControllerState(ControllerTypeRight) {
        m_jc_right = jc_right;
    };
    void accept(ControllerStateVisitor& visitor){ visitor.visit(*this); }
...
struct ControllerStatePair : ControllerState {
    ControllerStatePair(JoyConStatus jc_left, JoyConStatus jc_right) : ControllerState(ControllerTypePair) {
        m_jc_left = jc_left;
        m_jc_right = jc_right;
    };
    void accept(ControllerStateVisitor& visitor){ visitor.visit(*this); }
...
struct ControllerStateChargeGrip : ControllerState {
    ControllerStateChargeGrip(JoyConStatus jc_left, JoyConStatus jc_right) : ControllerState(ControllerTypeChargeGrip) {
            m_jc_left = jc_left;
            m_jc_right = jc_right;
    };
    void accept(ControllerStateVisitor& visitor){ visitor.visit(*this); }
...
struct ControllerStatePro : ControllerState {
    ControllerStatePro() : ControllerState(ControllerTypePro) {
